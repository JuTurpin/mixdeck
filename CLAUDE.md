...
**Prochaine action (voir `progress.md`)** : Epic 4 (plugins VST3/AU), Story 4.1 (scan automatique VST3/AU) validée — passer à la Story 4.2 (sélection manuelle du chemin d'un plugin).
