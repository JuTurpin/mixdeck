...
**Prochaine action (voir `progress.md`)** : Epic 4 terminé (hors backlog 4.5). Prochaine étape à discuter avec Julien — Epic 5 (bibliothèque SQLite) ou Epic 6 (build local), tous deux ne dépendant que de l'Epic 2 déjà terminé.
