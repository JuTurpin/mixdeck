...
**Prochaine action (voir `progress.md`)** : Epic 4 (plugins VST3/AU), Story 4.0 (spike incrustation JUCE/Electron) validée — passer à la Story 4.1 (scan automatique des dossiers standards VST3/AU).
