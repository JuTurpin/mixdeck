...
**Prochaine action (voir `progress.md`)** : Epic 4 (plugins VST3/AU), Story 4.2 (sélection manuelle du chemin, VST3) validée — passer à la Story 4.3 (chaîne d'effets par deck).
