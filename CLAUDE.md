...
- Une décision **encore ouverte**, à trancher avant de coder la story concernée :
...
**Prochaine action (voir `progress.md`)** : Epic 3 terminé (Story 3.3 validée) — démarrer l'Epic 4 (plugins VST3/AU), en tranchant d'abord ADR-011 (GUI native vs knobs génériques, story 4.0) avant la story 4.3.
