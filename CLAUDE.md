...
**Prochaine action (voir `progress.md`)** : Epic 4 (plugins VST3/AU), Story 4.4.1 (isolation hors-process VST3 — infrastructure + sécurité anti-crash) validée — passer à la Story 4.4.2 (streaming audio réel à travers un plugin isolé).
